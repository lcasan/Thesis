...
\begin{table}[!ht]
    ...
    \begin{tabularx}{\textwidth}{|c|X|c|}
        ...
        Eliminar usuario & Permite eliminar los datos de un usuario en la base de datos & RF4\\\hline
        ...
        Comunicar con pedal & Permite establecer o finalizar la comunicación entre la aplicación y el pedal motorizado & RF8, RF9\\\hline
        ...
        Mostrar rutinas & Permite visualizar una rutina de entrenamiento configurada anteriormente &RF14\\\hline
        Mostrar estadística & Permite mostrar estadísticas de las rutinas & RF15\\\hline
